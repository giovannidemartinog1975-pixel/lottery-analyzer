  ...
  return(
    ...
    <div style={{minHeight:"100vh",background:C.bg,fontFamily:"'Courier New',monospace",color:C.text,paddingBottom:60}}>
      <div style={{maxWidth:780,margin:"0 auto",padding:"0 12px"}}>
        <div style={{position:"sticky",top:0,zIndex:100,background:C.bg}}><div style={{padding:"8px 0 0",textAlign:"center",marginBottom:0}}>
        ...
        </div><div style={{display:"flex",gap:2,marginBottom:16,overflowX:"auto",paddingBottom:4,borderBottom:`1px solid ${C.border}`,paddingTop:8}}>

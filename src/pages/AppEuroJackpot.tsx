...
function TabBiglietti(){
  ...
  const loadTickets=async()=>{
    ...
    try{
      ...
      const dbTickets=data.map(r=>({id:r.id,nums:r.nums,bonus:r.bonus||[],date:r.data_gioco||"",concorso:r.concorso||0,strategy:r.strategy||"",sum:r.somma||0,fromDb:true,giocato:r.giocato||false}));
